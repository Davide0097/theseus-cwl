...
export const SOURCES: (CwlSource<Shape.Raw> & { title: string })[] = [
  {
    title: "Minimal valid workflow as YAML",
...
outputs: {}`,
  ...
  {
    title: "Minimal valid workflow as Object",
    entrypoint: "document.cwl",
    documents: [
      {
        name: "document.cwl",
  ...
  {
    title: "Minimal renderable workflow as object",
    entrypoint: "document.cwl",
    documents: [
      {
        name: "document.cwl",
  ...
  {
    title: "Minimal runnable workflow as YAML",
    entrypoint: "document.cwl",
    documents: [
      {
        name: "document.cwl",
...
steps:
  ...
  {
    title: "Minimal runnable CommandLineTool as Object",
    entrypoint: "document.cwl",
    documents: [
      {
        name: "document.cwl",
...
stdout: result.txt`,
  ...
  {
    title: "Minimal runnable CommandLineTool as YAML",
    entrypoint: "document.cwl",
    documents: [
      {
        name: "document.cwl",
...
stdout: result.txt`,
          ...
          steps: {
            step1: {
              run: {
                ...
                baseCommand: "echo",
                inputs: {
                  text: { type: "string", inputBinding: { position: 1 } },
                },
                outputs: {
                  out: { type: "File" },
                },
  ...
  {
    title: "One page workflow with parameters",
    entrypoint: "document.cwl",
    documents: [
      {
        name: "document.cwl",
    ...
    parameters: [
      {
        ...
        content: `{
    "message": "Hello inline tool"
  }`,
      },
    ],
  },
  {
    title: "One page workflow with parameters (2)",
    entrypoint: "document.cwl",
    documents: [
      {
        name: "document.cwl",
  ...
  {
    title: "Graph workflow from object (2)",
    entrypoint: "document.cwl",
    documents: [
      {
        name: "document.cwl",
          ...
          $graph: {
            "#main": {
              ...
              outputs: {
                deg_report: {
                  type: "File",
                  outputSource: "de_analysis/report",
                },
                counts_matrix: {
                  type: "File",
                  outputSource: "quantify/counts",
                },
              },
            },
            "#PerSampleQCWorkflow": {
        ...
        content: {
          ...
          $graph: {
            ...
            "#DEWorkflow": {
              ...
              inputs: { matrix: "File", metadata: "File" },
              outputs: {
                report: { type: "File", outputSource: "deseq/report" },
              },
              steps: {
                deseq: {
                  run: "#DESeq2Tool",
        ...
        content: {
          ...
          $graph: {
            "#main": {
              class: "Workflow",
              label:
                "Enterprise Multi-Source ETL to Data Lake + Warehouse Loader",
            ...
            "#APIIngestWorkflow": {
              ...
              outputs: {
                api_files: { type: "File", outputSource: "fetch/out" },
              },
              steps: {
                fetch: {
                  run: "#FetchAPI",
            ...
            "#EnrichmentWorkflow": {
              ...
              outputs: {
                enriched: { type: "File", outputSource: "lookup/out" },
              },
              steps: {
                lookup: {
                  run: "#LookupTool",
        ...
        content: {
          ...
          $graph: {
            ...
            "#SceneDetectWorkflow": {
              ...
              inputs: { video: "File" },
              outputs: {
                scenes: { type: "File[]", outputSource: "detect/out" },
              },
              steps: {
                keyframe: {
                  run: "#KeyframeTool",
            ...
            "#DetectionWorkflow": {
              ...
              outputs: {
                detections: { type: "File[]", outputSource: "infer/out" },
              },
              steps: {
                infer: {
                  run: "#DetectTool",
        ...
        content: {
          ...
          $graph: {
            "#main": {
              class: "Workflow",
              label:
                "Large-Scale Audio Processing & Speech Recognition Pipeline",
            ...
            "#VADWorkflow": {
              ...
              outputs: {
                segments: { type: "File[]", outputSource: "detect/out" },
              },
              steps: {
                frame: {
                  run: "#FrameTool",
        ...
        content: {
          ...
          $graph: {
            ...
            "#TransformWorkflow": {
              ...
              inputs: { record: "File" },
              outputs: {
                transformed: { type: "File", outputSource: "map/output" },
              },
              steps: {
                clean: {
                  run: "#CleanerTool",
        ...
        content: {
          ...
          $graph: {
            ...
            "#SimulationWorkflow": {
              ...
              outputs: {
                sim_output: { type: "File", outputSource: "run/out" },
              },
              steps: {
                run: {
                  run: "#SimulationTool",
